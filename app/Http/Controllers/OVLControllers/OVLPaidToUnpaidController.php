...
use App\OVLModel\OVLPaidToUnpaid;
use DB;
class OVLPaidToUnpaidController extends Controller
{
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $OVLHDRID)
    {
        ...
        $jvl= OVLPaidToUnpaid::findOrFail($OVLHDRID);
