...
use DB;
class OVLVehicleRateController extends Controller
{
    /**
    ...
    public function getAll(){
        ...
        $data = DB::select("SELECT b.MVRRID,b.MVID_Link,b.PlateNumber,b.EffectiveDate,b.PerHourRate from tblmotorvehiclelist as a, tblmotorvehiclerentalrate as b where a.MVID=b.MVID_Link and a.MVTypeName='OVL' order by b.MVRRID desc");
        return $data;
    }
}
