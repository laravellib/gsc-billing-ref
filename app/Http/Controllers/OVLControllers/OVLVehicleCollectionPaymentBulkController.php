...
use DB;
class OVLVehicleCollectionPaymentBulkController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
       ...
       /* $this->validate($request,[
        ...
        //return $jvl = OVLVehicleLogHDR::create($request->all());
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $OVLVCDTLID)
    {
        /*$this->validate($request,[
            'PlateNumber' => 'required|string|max:50',
            'EngineNumber' => 'required|string|max:50',
        ...
        date_default_timezone_set('Asia/Manila');
        $jvl= OVLVehicleCollectionPaymentDTL::findOrFail($OVLVCDTLID);
    ...
    public function destroy($id)
    {
        ...
        //$jvl->delete();
        $jvlshit =  DB::table('tblovlvehiclecollectionpaymentdtl')->where('OVLVLHDRID_Link',$id)->delete();
        return $jvlshit;
    }
