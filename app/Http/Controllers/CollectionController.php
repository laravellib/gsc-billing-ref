...
class CollectionController extends Controller
{
    ...
    public function getcollection(Request $request){
        // if($request['header']){
            $query = DB::connection('mysql')->select("SELECT * from tblcollection ORDER BY collectionID desc");
        // }elseif($request['detail']){
        //     $query = DB::connection('mysql')->select("SELECT * from tblpodtl WHERE hdr_idLink= ". $request['id'] ."  ORDER BY LName asc");
        // }
        return $query;
    ...
    public function getpercentage(Request $request){
            $query = DB::connection('mysql')->select("SELECT * from percentagesum ORDER BY PODtlid desc");
        return $query;
    }
