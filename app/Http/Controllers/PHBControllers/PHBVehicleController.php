...
use DB;
class PHBVehicleController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
       ...
       /* $this->validate($request,[
        ...
        return Vehicle::create([
            ...
            'startreading' => strtoupper($request['startreading']),
            'endreading' => strtoupper($request['endreading'])
        ]);
    ...
    public function getAll(){
        // return Vehicle::all();
       $data = DB::select("SELECT * from tblmotorvehiclelist  where MVTypeName='PHB' order by MVID desc");
       return $data;
    }
}
