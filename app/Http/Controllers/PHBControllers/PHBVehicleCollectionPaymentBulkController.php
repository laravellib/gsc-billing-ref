...
use DB;
class PHBVehicleCollectionPaymentBulkController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
       ...
       /* $this->validate($request,[
        ...
        //return $jvl = PHBVehicleLogHDR::create($request->all());
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $PHBVCDTLID)
    {
        /*$this->validate($request,[
            'PlateNumber' => 'required|string|max:50',
            'EngineNumber' => 'required|string|max:50',
        ...
        date_default_timezone_set('Asia/Manila');
        $jvl= PHBVehicleCollectionPaymentDTL::findOrFail($PHBVCDTLID);
    ...
    public function destroy($id)
    {
        ...
        //$jvl->delete();
        $jvlshit =  DB::table('tblphbvehiclecollectionpaymentdtl')->where('PHBVLHDRID_Link',$id)->delete();
        return $jvlshit;
    }
