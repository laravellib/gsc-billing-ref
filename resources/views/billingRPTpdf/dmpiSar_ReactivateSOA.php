		...
		<body>
			...
			<table width="100%" class="main_t">
				...
				<tbody>
					...
					<tr>
						<td style="text-align:center;"><?php echo date('Y-m-d',strtotime($record->Datetime_reactivation));  ?></td>
						<td style="text-align:center;"><?php  echo date('h:m:s A',strtotime($record->Datetime_reactivation)); ?></td>
						<td style="text-align:center;"><?php echo $record->soaNumber; ?></td>
						<td style="text-align:left;"><?php echo $record->Qty; ?></td>
                        <td style="text-align:left;"><?php echo $record->rate; ?></td>
						<td style="text-align:right;"><?php echo number_format((float)$record->total, 2, '.', ','); ?></td>
                        <td style="text-align:left;"><?php echo $record->reactivatedBy; ?></td>
                        <td style="text-align:left;"><?php echo $record->reasonofreactivation; ?></td>
					</tr>
