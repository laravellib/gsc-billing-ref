			...
			<table width="100%">
				<tr>
					...
					<td style="width:80%;text-align:center;padding-left:-20%;">
						...
						<h3 style="text-align:center;text-decoration:underline;">TRANSMITTAL FORM GOLFCART SOA</h3>
					</td>
				</tr>
				<tr>
			...
			<table width="100%" class="main_t">
				<thead>
					<tr style="background:lightgreen;">
						<th style="padding:20px 0;">Account Code</th>
						<th style="padding:20px 0;">Reference No.</th>
						<th style="padding:20px 0;">Transaction Date</th>
						<th style="padding:20px 0;">GolfCart No #</th>
				...
				<tbody>
					...
					<tr>
						<td style="text-align:center;"><?php echo $record->account_code; ?></td>
						<td style="text-align:center;"><?php echo $record->reference_no; ?></td>
						<td style="text-align:center;"><?php echo date("F j, Y", strtotime($record->trans_date)); ?></td>
						<td style="text-align:center;"><?php echo $record->golfcart_no; ?></td>
						<td style="text-align:right;"><?php echo number_format((float)$record->running_balance, 2, '.', ','); ?></td>
					</tr>
					<?php $total = $total + $record->running_balance; ?>
					<?php endforeach; ?>
					<tr>
