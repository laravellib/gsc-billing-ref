			...
			<table width="100%">
				<tr>
					...
					<td style="width:80%;text-align:center;padding-left:-20%;">
						...
						<h3 style="text-align:center;text-decoration:underline;">TRANSMITTAL FORM CONSTRUCTIONS</h3>
					</td>
				</tr>
				<tr>
			...
			<table width="100%" class="main_t">
				...
				<tbody>
					...
					<tr>
						...
						<td style="text-align:center;"><?php echo date("F j, Y", strtotime($record->soaDate)); ?></td>
						<td style="text-align:center;"></td>
						<td style="text-align:center;"></td>
						<td style="text-align:left;"><?php echo $record->companyName; ?></td>
