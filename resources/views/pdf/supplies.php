...
?>
	<html xmlns:x="urn:schemas-microsoft-com:office:excel">
		...
		<body>
			...
			<table width="100%">
				<tr>
					<td style="width:30%;padding:1px;">To : <b>MR. EDGRADO VALIENTE</b></td>
					<td style="width:40%;padding:1px;"></td>
					<td style="width:30%;padding:1px;text-align:center;"><b>SOA #</b> : <?php echo $SOANo; ?></td>
				</tr>
				<tr>
					<td style="padding:1px;">Camp Administration Office</td>
					<td style="padding:1px;"></td>
					<td style="padding:1px;text-align:center;">Account to Charge</td>
				</tr>
				<tr>
					<td style="padding:1px;">Del Monte Philippines, inc.</td>
					<td style="padding:1px;"></td>
					<td style="padding:1px;text-align:center;"><?php echo $GL; ?></td>
				</tr>
				<tr>
					<td><br><br><br></td>
				</tr>
				<tr>
					<td style="padding:1px;"></td>
					<td style="padding:1px;"></td>
					<td style="padding:1px;text-align:center;">COST CENTER</td>
				</tr>
				<tr>
					<td style="padding:1px;"></td>
					<td style="padding:1px;"></td>
					<td style="padding:1px;text-align:center;"><?php echo $CC; ?></td>
				</tr>
				<tr>
					<td colspan="3" style=""><br><br>This is to bill the following items purchased by GSMPC for Camp Administration Office.</td>
				</tr>
			</table>
			<br>
			<table width="100%" class="main_t">
				<thead>
					<tr style="background:lightgrey;">
						<th style="width:30%;padding:10px 0;">ITEM</th>
						<th style="width:10%;padding:10px 0;">QUANTITY</th>
						<th style="width:10%;padding:10px 0;">UNIT</th>
						<th style="width:15%;padding:10px 0;">UNIT PRICE</th>
						<th style="width:15%;padding:10px 0;">5% of unit price</th>
						<th style="width:15%;padding:10px 0;">Unit Price + 5%</th>
						<th style="width:15%;padding:10px 0;">AMOUNT</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td style="text-align:right;"><?php echo number_format((float)$record->subPrice - $record->Price, 2, '.', ','); ?></td>
					...
					<?php endforeach; ?>
					<tr>
						<td colspan="6" style="text-align:right;color:red;border:none;font-weight:bold;">TOTAL AMOUNT</td>
				...
				<tr>
					<td>
						<table width="100%">
							...
							<tr>
								<td style="font-weight:bold;">Verified & Checked By:</td>
								<td style="font-weight:bold;"></td>
								<td style="font-weight:bold;"></td>
								<td style="font-weight:bold;"></td>
								<td style="font-weight:bold;"></td>
							...
							<tr>
								...
								<td style="font-weight:bold;"></td>
								<td style="font-weight:bold;"></td>
								<td style="font-weight:bold;">Prepared for payment:</td>
								<td style="font-weight:bold;"></td>
							</tr>
							<tr>
								<td></td>
