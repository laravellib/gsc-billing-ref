      ...
      <div class="row mt-3">
            ...
            <div class="modal-body">
              <div class="form-group">
                <input
                  ...
                  :class="{
                                        'is-invalid': form.errors.has('FirstName')
                                    }"
                />
              ...
              <div class="form-group">
                <input
                  ...
                  :class="{
                                        'is-invalid': form.errors.has('MiddleName')
                                    }"
                />
              ...
              <div class="form-group">
                <input
                  ...
                  :class="{
                                        'is-invalid': form.errors.has('LastName')
                                    }"
                />
              ...
              <div class="form-group">
                <input
                  ...
                  placeholder="ExtName"
                  :class="{
                                        'is-invalid': form.errors.has('ExtName')
                                    }"
                />
                <has-error :form="form" field="ExtName"></has-error>
              </div>
              <div class="form-group">
                <input
                  type="text"
        ...
        <div class="col-sm-8">
          ...
          >
            ...
            <kendo-grid-column :field="'MiddleName'" :title="'MiddleName'"></kendo-grid-column>
            <kendo-grid-column :field="'LastName'" :title="'LastName'"></kendo-grid-column>
            <kendo-grid-column :field="'ExtName'" :title="'ExtName'"></kendo-grid-column>
