        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><b>CONSTRUCTION PAYMENT FORM</b></h3>
                                ...
                                <tbody class="dave-tbody">
                                    ...
                                    <tr v-for="item in filteredBlogs">
                                        ...
                                        <td class="text-center">
                                            {{ item.soaDate | formatDate }}
                                        </td>
                                        <td class="text-right">
                                            {{
                                                item.amountInFigure | formatNumber
                                            }}
                                        </td>
                                        <td class="text-right">
                                            {{
...
export default {
    ...
    methods: {
        ...
        checkSoa(soaget) {
            this.header.hdr_idLink = soaget.soaID;
            this.header.billed_amount = soaget.amountInFigure;
            this.header.SOANo = soaget.SOANo;
            this.SOANo = soaget.SOANo;
            $("#soa").modal("hide");
        },
        appendSOANo() {
            if (!this.SOANo) {
            ...
            axios
                .get("api/allowance", {
                    params: { getViewConstruction: true, SOANo: this.SOANo }
                })
                .then(response => {
        ...
        totalBilling() {
            var total = 0;
            this.headerList.forEach(function(item) {
                total = total + item.amountInFigure;
            });
        ...
        savePayment() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios
                        .post("api/constructionPayment", data)
                        .then(response => {
