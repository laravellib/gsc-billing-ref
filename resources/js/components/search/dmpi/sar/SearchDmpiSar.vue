<template>
    <div class="container">
        <!-- modal  -->
        <div class="modal fade" id="searchDmpiSar" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                <h4 class="modal-title">Search DMPI SAR</h4>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getSoa(){
                axios({method: 'GET', url: '/api/dmpisarsearch'}).then(({ data }) => (this.soas = data))
