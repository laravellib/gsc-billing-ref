    ...
    <div class="container">
        ...
        <div class="modal fade" id="searchSOA" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h4 class="modal-title">Search OVL SOA</h4>
                ...
                <table class="table table-hover" >
                        ...
                        <tbody>
                        <tr id="element" style="cursor:pointer;" v-for="soa in filteredBlogs" v-bind:key="soa.Soa_OVLID" v-on:click="changeTitleSOA(soa)">
                            <td>{{soa.GSCSoaSeriesNo}}</td>
                            <td>{{soa.OVLSoaDate}}</td>
                            <td>{{soa.Status}}</td>
                            <!--<td>
                                <center>
