    ...
    <div class="col-xs-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title" ><b>PHB Vehicle List</b></h3>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document" style="overflow-y: initial !important;">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" v-show="!editmode" id="addNewLabel">Add New PHB Vehicle</h5>
            <h5 class="modal-title" v-show="editmode" id="addNewLabel">Update PHB Vehicle's Info</h5>
...
export default {
  ...
  methods: {
      ...
      getResults(page = 1){
        axios.get('api/phbvehicle?page=' + page).then(response => {
      ...
      deleteModal(MVID){
            ...
            if (result.value) {
                this.$Progress.start();
                $('#addNew').modal('hide');
                this.form.delete('api/phbvehicle/'+MVID);
                swal.fire(
                'Deleted!',
     ...
     axios.get('api/getSearchPHBVehicle')
     .then(response => {
    ...
    createVehicle() {
      ...
      this.loadVehicle();*/
      this.$Progress.start();
      this.form.post("api/phbvehicle").then(()=>{
        $('#addNew').modal('hide');
        $('.modal-backdrop').remove();
        toast.fire({
          icon: "success",
