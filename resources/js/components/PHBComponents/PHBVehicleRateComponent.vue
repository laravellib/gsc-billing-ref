    ...
    <div class="col-xs-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><b>PHB Rate List</b></h3>
          ...
          <table class="table table-hover" >
            <tbody>
              ...
              <tr v-for="vr in vehiclerates" v-bind:key="vr.MVRRID">
                ...
                <td>{{'Php '+vr.PerKilometerRate.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}}</td>
                <td>
              ...
              <!--Search Vehicle Plate-->
                ...
                <div class="form-inline">
                    <div class="input-group mb-3 input-group-sm" style="margin-left:5px;">
                         ...
                         <input class="form-control" type="decimal" v-model="form.PerKilometerRate" placeholder="Per Kilometer Rate">
                    </div>
                </div>
                <!--<div class="input-group">
...
mounted() {
  ...
  methods: {
    ...
    getVehicleIsReal(){
      ...
      deleteModal(MVRRID){
            ...
            if (result.value) {
                this.$Progress.start();
                $('#addNew').modal('hide');
                this.form.delete('api/phbvehiclerate/'+MVRRID);
                swal.fire(
                'Deleted!',
    ...
    loadVehicleRate() {
     ...
     axios.get('api/getSearchPHBVehicleRate')
     .then(response => {
            this.vehiclerates = response.data;
    ...
    createVehicleRate() {
      this.$Progress.start();
      this.form.post("api/phbvehiclerate").then(()=>{
        $('#addNew').modal('hide');
