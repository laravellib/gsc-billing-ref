      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Create Van Rental SOA</h4>
  ...
  methods: {
    get_signatory(data) {
      ...
      axios.get("req_soa/details/" + this.form.id).then(({ data }) => {
        ...
        doc.save("vanrental_soa_" + this.form.series_no + ".pdf");
      });
    ...
    post_soa() {
      if (this.form.id == "") {
        ...
        this.form
          .put("api/vanrental_soa_hdr/" + this.form.id)
          .then(() => {
            toast.fire({
              icon: "success",
