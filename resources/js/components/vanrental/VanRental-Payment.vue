    ...
    <div class="row">
      ...
      <div class="container">
        <div class="row mt-3">
          ...
          <div class="col-sm">
            <select class="form-control form-control-sm" :required="true" v-model="payment_type">
              <option value="REQ">DMPI w/ PO</option>
              <option value="MONTHLY">NON PO</option>
            </select>
          </div>
          <div class="col">
