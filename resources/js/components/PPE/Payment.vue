        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><b>PPE PAYMENT FORM</b></h3>
...
export default {
    ...
    methods: {
        appendSOANo() {
            ...
            axios
                .get("api/ppe", {
                    params: { getViewPPE: true, SOANo: this.SOANo }
                })
                .then(response => {
        ...
        getDetail() {
            if (this.header.PHID) {
                axios
                    .get("api/ppe", {
                        params: { getPaymentDetail: true, id: this.header.PHID }
                    })
                    .then(response => {
                        if (response.data.length > 0) {
        ...
        savePayment() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios
                        .post("api/ppePayment", data)
                        .then(response => {
                            if (response.data.success) {
                                if (response.data.id) {
                                    this.header.PPID = response.data.id;
                                }
                                toast.fire({
                                    icon: "success",
        ...
        deletePaymentDetail() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios
                        .delete(
                            `api/ppePaymentDelete/${this.detail.PPID}`
                        )
                        .then(response => {
                            if (response.data.success) {
                                this.clearFunction("detail");
