      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Search Charge Invoice</h4>
          ...
          <div class="modal-body">
            ...
            >
              ...
              <kendo-grid-column :field="'ch_no'" :title="'Charge #'"></kendo-grid-column>
              <kendo-grid-column :field="'date'" :title="'Date'"></kendo-grid-column>
              <kendo-grid-column :field="'charged'" :title="'Charged'"></kendo-grid-column>
...
export default {
  ...
  methods: {
    loadMode() {
      axios.get("liftruck/hdr_ci").then(({ data }) => {
