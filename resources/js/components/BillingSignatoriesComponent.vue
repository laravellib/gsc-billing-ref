<template>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
        <tr class="hover-green" v-for="(signatory) in signatories.data" v-bind:key="signatory.id">
            ...
            <td>
                <div>
                    ...
                    <b-button @click="editMode(signatory)" variant="info"><i class="fa fa-edit"></i></b-button>
                    <b-button @click="deleteSignatory(signatory.id)" variant="danger"> <i class="fa fa-trash"></i></b-button>
                    </b-button-group>
                </div>
            </td>
        </tr>
    ...
    <div class="modal fade" id="addNewSignatory" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form @submit.prevent="isEdit ? updateSignatory() : addNewSignatory()">
...
import { log } from 'util';
    ...
    export default {
        ...
        methods: {
            ...
            toUpper(){
                this.form.fname = this.$parent.toCapitalizeFirstLetter(this.form.fname);
                this.form.ename = this.$parent.toCapitalizeFirstLetter(this.form.ename);
                this.form.lname = this.$parent.toCapitalizeFirstLetter(this.form.lname);
                this.form.mname = this.$parent.toCapitalizeFirstLetter(this.form.mname);
                this.form.position = this.$parent.toCapitalizeFirstLetter(this.form.position);
            },
           addNewSignatory(e){
