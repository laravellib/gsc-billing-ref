      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Create Wing Van SOA</h4>
...
export default {
  ...
  methods: {
    get_signatory(data) {
      ...
      axios.get("wreq_soa/details/" + this.form.id).then(({ data }) => {
        ...
        doc.save("wingvan_soa_" + this.form.series_no + ".pdf");
      });
    ...
    post_soa() {
      if (this.form.id == "") {
        ...
        this.form
          .put("api/wingvan_soa_hdr/" + this.form.id)
          .then(() => {
            toast.fire({
              icon: "success",
  ...
  mounted() {},
  created() {
    this.form.series_no = "WSOA-" + moment().format("HHMMSS");
