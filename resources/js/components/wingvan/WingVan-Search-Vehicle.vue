      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Search Wing Van Vehicle</h4>
          ...
          <div class="modal-body">
            ...
            >
              ...
              <kendo-grid-column :field="'daily_rate'" :title="'Daily Rate'"></kendo-grid-column>
            </kendo-grid>
          </div>
...
export default {
  ...
  methods: {
    loadMode() {
      axios.get("motorvehicle_rate_list/5").then(({ data }) => {
