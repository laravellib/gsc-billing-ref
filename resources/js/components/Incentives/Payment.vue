        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><b>INCENTIVES PAYMENT FORM</b></h3>
...
export default {
    ...
    methods: {
        appendSOANo() {
            ...
            axios
                .get("api/incentives", {
                    params: { getViewIncentives: true, SOANo: this.SOANo }
                })
                .then(response => {
        ...
        getDetail() {
            if (this.header.IHID) {
                axios
                    .get("api/incentives", {
                        params: { getPaymentDetail: true, id: this.header.IHID }
                    })
                    .then(response => {
                        if (response.data.length > 0) {
        ...
        savePayment() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios
                        .post("api/incentivesPayment", data)
                        .then(response => {
                            if (response.data.success) {
                                if (response.data.id) {
                                    this.header.IPID = response.data.id;
                                }
                                toast.fire({
                                    icon: "success",
        ...
        deletePaymentDetail() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios
                        .delete(
                            `api/incentivesPaymentDelete/${this.detail.IPID}`
                        )
                        .then(response => {
                            if (response.data.success) {
                                this.clearFunction("detail");
