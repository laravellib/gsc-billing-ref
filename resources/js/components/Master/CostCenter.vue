      ...
      <div class="row mt-3"> 
          ...
          <form @submit.prevent="editMode ? updateData() : createData()">
            <div class="modal-body">
              <div class="form-group">
                <label>Add New Cost Center</label>
                <input
                  type="text"
                  ...
                  :class="{
                                        'is-invalid': form.errors.has('costcenter')
                                    }"
                />
                <has-error :form="form" field="costcenter"></has-error>
              </div>
            </div>
        ...
        <div class="col-sm-8">
          ...
          >
            ...
            <kendo-grid-column :field="'costcenter'" :title="'Cost Center'"></kendo-grid-column>
...
export default {
  ...
  methods: {
    updateData() {
      this.form
        .put("api/costcenter/" + this.form.id)
        .then(() => {
    ...
    loadData() {
      axios.get("api/costcenter").then(({ data }) => {
        this.data_ = data;
