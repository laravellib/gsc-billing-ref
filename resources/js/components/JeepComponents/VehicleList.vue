    ...
    <div class="col-xs-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title" ><b>JEEP Vehicle List</b></h3>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" v-show="!editmode" id="addNewLabel">Add New Vehicle</h5>
            <h5 class="modal-title" v-show="editmode" id="addNewLabel">Update Vehicle's Info</h5>
  ...
  methods: {
      ...
      deleteModal(MVID){
            ...
            if (result.value) {
                this.$Progress.start();
                $('#addNew').modal('hide');
                this.form.delete('api/vehicle/'+MVID);
                swal.fire(
                'Deleted!',
    ...
    createVehicle() {
      ...
      this.loadVehicle();*/
      this.$Progress.start();
      this.form.post("api/vehicle").then(()=>{
        $('#addNew').modal('hide');
        $('.modal-backdrop').remove();
        toast.fire({
          icon: "success",
