        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <b>Create/Generate OTHERS Transmittal</b>
                    </h3>
...
export default {
    ...
    methods: {
                                                ...
                                                if (response.data.success) {
                                                    ...
                                                    window.open(
                                                        "api/reportAllowanceTransmittal?report=true&transmittal_no=" +
                                                            this.transmittal_no + "&type=OTHERS"
                                                    );
                                                    this.transmittal_no = "";
                                                    this.generate();
                                                    this.getUser();
        ...
        printTransmittal() {
            axios
                .get("api/reportAllowanceTransmittal", { params: { searchTransmittalExists: true, transmittal_no: this.transmittal_no, type: "OTHERS" } })
                .then(response => {
                    if (response.data.success) {
                        window.open(
                            "api/reportAllowanceTransmittal?report=true&transmittal_no=" +
