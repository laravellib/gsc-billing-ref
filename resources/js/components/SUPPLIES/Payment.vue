        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><b>SUPPLIES PAYMENT FORM</b></h3>
...
export default {
    ...
    methods: {
        appendSOANo() {
            ...
            axios
                .get("api/sup", {
                    params: { getViewSUP: true, SOANo: this.SOANo }
                })
                .then(response => {
        ...
        getDetail() {
            if (this.header.SHID) {
                axios
                    .get("api/sup", {
                        params: { getPaymentDetail: true, id: this.header.SHID }
                    })
                    .then(response => {
                        if (response.data.length > 0) {
        ...
        savePayment() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios
                        .post("api/supPayment", data)
                        .then(response => {
                            if (response.data.success) {
                                if (response.data.id) {
                                    this.header.SPID = response.data.id;
                                }
                                toast.fire({
                                    icon: "success",
        ...
        deletePaymentDetail() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios
                        .delete(
                            `api/supPaymentDelete/${this.detail.SPID}`
                        )
                        .then(response => {
                            if (response.data.success) {
                                this.clearFunction("detail");
