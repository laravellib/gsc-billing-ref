        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><b>FUEL PAYMENT FORM</b></h3>
...
export default {
    ...
    methods: {
        appendSOANo() {
            ...
            axios
                .get("api/fuel", {
                    params: { getViewFUEL: true, SOANo: this.SOANo }
                })
                .then(response => {
        ...
        getDetail() {
            if (this.header.FHID) {
                axios
                    .get("api/fuel", {
                        params: { getPaymentDetail: true, id: this.header.FHID }
                    })
                    .then(response => {
                        if (response.data.length > 0) {
        ...
        savePayment() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios
                        .post("api/fuelPayment", data)
                        .then(response => {
                            if (response.data.success) {
                                if (response.data.id) {
                                    this.header.FPID = response.data.id;
                                }
                                toast.fire({
                                    icon: "success",
        ...
        deletePaymentDetail() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios
                        .delete(
                            `api/fuelPaymentDelete/${this.detail.FPID}`
                        )
                        .then(response => {
                            if (response.data.success) {
                                this.clearFunction("detail");
