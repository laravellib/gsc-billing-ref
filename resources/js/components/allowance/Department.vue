...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            this.$Progress.start();
            axios
                .post("api/allowanceDepartment", data)
                .then(response => {
                    if (response.data.success) {
                        if (response.data.id) {
                            this.header.ADID = response.data.id;
                        }
                        toast.fire({
                            icon: "success",
        ...
        deleteFUELListButton() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    this.$Progress.start();
                    axios
                        .delete(`api/allowanceDepartmentDelete/${this.header.ADID}`)
                        .then(response => {
                            if (response.data.success) {
                                this.getData();
                                this.clearButton();
                ...
                return this.search
                    ...
                    .every(
                        v =>
                            ...
                            item.Department.toLowerCase().includes(v)
                    );
            });
        }
    }
