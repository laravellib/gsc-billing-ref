...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    detailView: function detailView() {
      ...
      console.log("sweget");
      axios.get('/api/getcphbsoaforviewindiviual', {
        params: {
          Soa_PHBID: this.formSOA.Soa_PHBID
        }
      }).then(function (response) {
        _this.detailSOAIndividual = response.data;
        console.log(_this.detailSOAIndividual);
      ...
      if (typeof this.formSOA.Soa_PHBID == "undefined" || this.formSOA.Soa_PHBID == "") {
        ...
        swal.fire({
          ...
          if (result.value) {
            ...
            axios.get('/api/cancelstatusphbsoa', {
              params: {
                Soa_PHBID: _this3.formSOA.Soa_PHBID,
            ...
            _this3.$Progress.finish(); //location.reload();
    ...
    individualSOA: function individualSOA(soa) {
      this.formSOA.reset();
      this.formSOA.Soa_PHBID = soa.Soa_PHBID;
      ...
      this.formSOA.PHBSoaDate = soa.PHBSoaDate;
    ...
    soasetpaid: function soasetpaid() {
      ...
      this.formSOA.Soa_PHBID = this.checkedNames.join();
      ...
      if (typeof this.formSOA.Soa_PHBID == "undefined" || this.formSOA.Soa_PHBID == "") {
        ...
        swal.fire({
          ...
          if (result.value) {
            ...
            _this4.formSOA.Status = "PAID/COLLECTED";
            axios.get('/api/updatestatussoaphbmultiple', {
              params: {
                Soa_PHBID: _this4.formSOA.Soa_PHBID,
            ...
            _this4.checkedNames = "";
            _this4.allSelected = false; //location.reload();
          }
        });
      }
    },
      ...
      if (typeof this.formSOA.Soa_PHBID == "undefined" || this.formSOA.Soa_PHBID == "") {
        ...
        swal.fire({
          ...
          if (result.value) {
            ...
            $('#addNew').modal('hide');
            _this5.formSOA.Status = "POSTED";
            axios.get('/api/updatestatusphbsoa', {
              params: {
                Soa_PHBID: _this5.formSOA.Soa_PHBID,
                Status: _this5.formSOA.Status
              }
            }).then(function (_ref5) {//this.csoas = data;

              var data = _ref5.data;
            })["catch"](function (err) {}); //UPDATE SOA

            _this5.form.PHBVLHDRID = _this5.checkedNames.join();
            axios.get('/api/updatephbvlsoa', {
              params: {
                PHBVLHDRID: _this5.form.PHBVLHDRID,
                Soa_PHBID: _this5.formSOA.Soa_PHBID,
                GSCSoaSeriesNo: _this5.formSOA.GSCSoaSeriesNo,
                PHBSoaDate: _this5.formSOA.PHBSoaDate
              }
            }).then(function (_ref6) {
              var data = _ref6.data;
              _this5.csoatotals = data;
    ...
    downloadPDFSOA: function downloadPDFSOA() {
      ...
      if (typeof this.formSOA.Soa_PHBID == "undefined" || this.formSOA.Soa_PHBID == "") {
        ...
        pdf.setLineWidth(.2);
        pdf.line(93, 106, 93 + textWidth, 106);
        pdf.setFontType("regular");
        pdf.setFontSize(10);
    ...
    selectAll: function selectAll() {
      ...
      if (this.allSelected == false) {
        for (var user in this.filteredBlogs) {
          this.checkedNames.push(this.filteredBlogs[user].Soa_PHBID);
        }
      }
    },
      ...
      if (this.form.PHBVLHDRID == "") {
        ...
        axios.get('/api/getcphbsoasum', {
          ...
          if (_this7.checkedNames == "") {
            ...
            _this7.form.Status = "ACTIVE"; //this.form.TotalAmount=parseFloat(this.total).toFixed(2);

            _this7.form.TotalAmount = "";
            _this7.form.PHBVLHDRID = _this7.checkedNames.join();
            axios.get('/api/getcphbsoasum', {
              params: {
                PHBVLHDRID: _this7.form.PHBVLHDRID
              }
            }).then(function (_ref8) {
              var data = _ref8.data;
              _this7.csoatotals = data;
              _this7.form.TotalAmount = parseFloat(_this7.csoatotals[0].BillAmount).toFixed(2);
              console.log(_this7.form.TotalAmount);
            })["catch"](function (err) {});
            var d = new Date();
            var today = new Date().toISOString().slice(0, 10);
            _this7.form.PHBSoaDate = today;
            axios.get('/api/getcphbsoa', {
              params: {
                PHBSoaDate: _this7.form.PHBSoaDate
              }
            }).then(function (_ref9) {
              var data = _ref9.data;
              _this7.csoacounts = data;

              if (_this7.csoacounts[0].SOAIncrement == 0) {
                _this7.form.GSCSoaSeriesNo = "PUJ" + new Date().getFullYear() + new Date().toISOString().slice(5, 7) + "-1";
              } else {
                var num = _this7.csoacounts[0].SOAIncrement + 1;
                _this7.form.GSCSoaSeriesNo = "PUJ" + new Date().getFullYear() + new Date().toISOString().slice(5, 7) + '-' + num;
              }
            })["catch"](function (err) {});
            $('#addNew').modal('show');
          }
    ...
    loadCSOA: function loadCSOA() {
      ...
      //axios.get("api/jvl").then(({ data }) => (this.jvls = data));
      axios.get('api/getcphbsoasoa').then(function (response) {
        _this9.csoas = response.data;
        console.log(_this9.csoas);
      })["catch"](function (error) {
        console.log(error);
      });
    },
    loadJVCP: function loadJVCP() {
      ...
      axios.get("api/jvcp").then(function (_ref10) {
        var data = _ref10.data;
        return _this10.jvcps = data;
      });
    },
    ...
    createJVCP: function createJVCP() {
      ...
      this.form.post("api/jvcp").then(function () {
        ...
        _this12.form.CollectedAmount = ""; //this.form.BalanceAmount=0;
    ...
    getJVLBalanceAmount: function getJVLBalanceAmount() {
      ...
      axios.get('/api/getphbbalanceamount', {
        params: {
          PHBVLHDRID: this.form.PHBVLHDRID
        }
      }).then(function (response) {
        _this13.jvlbalamt = response.data;
        _this13.form.BalanceAmountHDR = _this13.jvlbalamt[0].BalanceAmount;
        console.log(_this13.jvlbalamt[0].BalanceAmount);
      })["catch"](function (err) {});
    },
    createJVCPMultiple: function createJVCPMultiple() {
      ...
      swal.fire({
        ...
        if (result.value) {
          _this14.$Progress.start(); ////console.log(this.checkedNames);


          var arr = 0;

          for (var i = 0; i < _this14.checkedNames.length; i++) {
            arr = i;
            console.log(_this14.checkedNames.length);
            _this14.form.PHBVLHDRID_Link = _this14.checkedNames[i]; //console.log(this.form.PHBVLHDRID_Link);
            //UPDATE VEHICLE LOG HDR

            _this14.form.put('api/phbvlphbvcp/' + _this14.checkedNames[i]);

            $('#addNewMultiple').modal('hide'); //END UPDATE
            //CREATE INSERT TO PHB VEHICLE COLLECTION PAYMENT

            _this14.form.post("api/jvcp").then(function () {
              //toast.fire({
              //   icon: "success",
          ...
          _this14.$Progress.finish(); //location.reload();


          _this14.loadJVL();

          _this14.checkedNames = [];
        }
      });
    }
  },
    ...
    filteredBlogs: function filteredBlogs() {
      ...
      return _.filter(vm.csoas, function (data) {
        if (_.isNull(startdate) && _.isNull(enddate)) {
          return true;
          this.filteredblogs = data.PHBSoaDate;
        } else {
          var date = data.PHBSoaDate;
      ...
      return this.jvls.filter((samsung) => {
        ...
        this.filteredblogs = samsung.PHBVLHDRID;
      });
      }*/
    },
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=style&index=0&lang=css&":
/*!******************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=style&index=0&lang=css&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=style&index=0&lang=css& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../../node_modules/css-loader??ref--6-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--6-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./PHBSOAList.vue?vue&type=style&index=0&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=style&index=0&lang=css&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=template&id=bbb2d05a&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=template&id=bbb2d05a& ***!
  \***************************************************************************************************************************************************************************************************************************/
                        ...
                        _c("input", {
                          ...
                          domProps: {
                            ...
                            checked: Array.isArray(_vm.checkedNames)
                              ? _vm._i(_vm.checkedNames, soa.Soa_PHBID) > -1
                              : _vm.checkedNames
                          },
                          on: {
                            change: function($event) {
            ...
            _c(
              ...
              [
                ...
                _c(
                  ...
                  [
                    _vm._v(
                      "\n                  Create PHB SOA Transaction Form\n                  "
                    ),
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            ...
                            [_vm._v("     " + _vm._s(_vm.formSOA.BodyofLetter))]
                          )
                        ]
                      )
                    ]),
                          ...
                          _c(
                            ...
                            [
                              ...
                              _c("input", {
                                ...
                                domProps: { value: _vm.formSOA.PreparedByPos },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
...
/***/ "./resources/js/components/PHBComponents/PHBSOAList.vue":
/*!**************************************************************!*\
  !*** ./resources/js/components/PHBComponents/PHBSOAList.vue ***!
  \**************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _PHBSOAList_vue_vue_type_template_id_bbb2d05a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PHBSOAList.vue?vue&type=template&id=bbb2d05a& */ "./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=template&id=bbb2d05a&");
/* harmony import */ var _PHBSOAList_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PHBSOAList.vue?vue&type=script&lang=js& */ "./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _PHBSOAList_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PHBSOAList.vue?vue&type=style&index=0&lang=css& */ "./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=style&index=0&lang=css&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _PHBSOAList_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _PHBSOAList_vue_vue_type_template_id_bbb2d05a___WEBPACK_IMPORTED_MODULE_0__["render"],
  _PHBSOAList_vue_vue_type_template_id_bbb2d05a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/PHBComponents/PHBSOAList.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=script&lang=js&":
/*!***************************************************************************************!*\
  !*** ./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./PHBSOAList.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=style&index=0&lang=css&":
/*!***********************************************************************************************!*\
  !*** ./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=style&index=0&lang=css& ***!
  \***********************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader!../../../../node_modules/css-loader??ref--6-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--6-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./PHBSOAList.vue?vue&type=style&index=0&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=style&index=0&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 

/***/ }),

/***/ "./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=template&id=bbb2d05a&":
/*!*********************************************************************************************!*\
  !*** ./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=template&id=bbb2d05a& ***!
  \*********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_template_id_bbb2d05a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./PHBSOAList.vue?vue&type=template&id=bbb2d05a& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/PHBComponents/PHBSOAList.vue?vue&type=template&id=bbb2d05a&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_template_id_bbb2d05a___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PHBSOAList_vue_vue_type_template_id_bbb2d05a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
