  ...
  methods: {
    ...
    getMarkup: function getMarkup() {
      ...
      axios.get("api/markup").then(function (response) {
        _this4.markup = response.data[0].FuelMarkUp;
    ...
    saveHdr: function saveHdr() {
      ...
      axios.post("api/fuelHdr", data).then(function (response) {
        if (response.data.success) {
          ...
          if (response.data.id) {
            _this5.header.FHID = response.data.id;
          }
    ...
    deleteHdr: function deleteHdr() {
      ...
      swal.fire({
        ...
        if (result.value) {
          ...
          axios["delete"]("api/fuelHdrDelete/".concat(_this6.header.FHID)).then(function (response) {
            if (response.data.success) {
              _this6.clearAll();
    ...
    saveDtl: function saveDtl() {
      ...
      axios.post("api/fuelDtl", data).then(function (response) {
        if (response.data.success) {
          if (response.data.id) {
            _this7.header.FEDID = response.data.id;
          }
    ...
    deleteDtl: function deleteDtl() {
      ...
      swal.fire({
        ...
        if (result.value) {
          ...
          axios["delete"]("api/deleteFUELHDR/".concat(_this8.dtl.FEDID)).then(function (response) {
            if (response.data.success) {
              _this8.getDetail();
    ...
    generatePrint: function generatePrint() {
      ...
      axios.get("api/reportFUEL", {
        ...
        if (response.data.success) {
          _this9.reportData.url2 = "api/reportFUEL?report=true&SOANo=" + _this9.header.SOANo;
        } else {
          swal.fire("Warning!", response.data.message, "warning");
        }
    ...
    viewReport: function viewReport() {
      ...
      if (this.modalPage == 1) {
        ...
        axios.post("api/reportAllowanceSOASave", {
          ...
          if (response.data.success) {
            _this11.reportData.url1 = "api/reportSOA?report=true&SOANo=" + _this11.header.SOANo + "&Prepared_by=" + _this11.reportData.Prepared_by + "&Checked_by=" + _this11.reportData.Checked_by + "&Noted_by=" + _this11.reportData.Noted_by + "&Approved_by=" + _this11.reportData.Approved_by + "&reportID=" + response.data.id + "&type=FUEL";
          }
