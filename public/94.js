...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Incentives/Transmittal.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Incentives/Transmittal.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************/
...
/* harmony import */ var _Incentives_ShowDetailModal_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Incentives/ShowDetailModal.vue */ "./resources/js/components/Incentives/ShowDetailModal.vue");
/* harmony import */ var _search_SearchAllowance_SearchIncentivesHeader_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../search/SearchAllowance/SearchIncentivesHeader.vue */ "./resources/js/components/search/SearchAllowance/SearchIncentivesHeader.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    "search-incentivesDetail": _Incentives_ShowDetailModal_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
    "search-incentivesHeader": _search_SearchAllowance_SearchIncentivesHeader_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  data: function data() {
    return {
  ...
  methods: {
    checkTableAll: function checkTableAll() {
      ...
      if (!this.checkHeader) {
        ...
        this.rows.forEach(function (item) {
          arrays.push(item);
          document.getElementById(item.IHID).checked = true;
        });
        this.checkTableArrays = arrays;
      } else {
        this.rows.forEach(function (item) {
          document.getElementById(item.IHID).checked = false;
        });
    ...
    clickDetails: function clickDetails(id) {
      Fire.$emit("searchIncentivesDetail", id);
    },
                ...
                if (result.value) {
                  ...
                  axios.post("api/allowanceCreateTransmittal", data).then(function (response) {
                    if (response.data.success) {
                      ...
                      _this4.prepared_by = "";
                      _this4.SoaTransNo = "";
                      window.open("api/reportAllowanceTransmittal?report=true&transmittal_no=" + _this4.transmittal_no + "&type=INCENTIVES");
    ...
    searchIncentivesHeader: function searchIncentivesHeader() {
      Fire.$emit("searchIncentivesHeader", "transmittal");
    },
    incentivesHeaderClose: function incentivesHeaderClose(row) {
      this.SoaTransNo = row.SOANo + " ( " + row.transmittal_no + ")";
      this.SOANo = row.SOANo;
    },
    searchTransmittal: function searchTransmittal() {
      Fire.$emit("searchTransmittal", "incentives");
    },
    ...
    printTransmittal: function printTransmittal() {
      ...
      axios.get("api/reportAllowanceTransmittal", {
        ...
        if (response.data.success) {
          window.open("api/reportAllowanceTransmittal?report=true&transmittal_no=" + _this6.transmittal_no + "&type=INCENTIVES");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Incentives/Transmittal.vue?vue&type=template&id=30e37bd3&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Incentives/Transmittal.vue?vue&type=template&id=30e37bd3& ***!
  \*************************************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c(
    ...
    [
                        ...
                        return _c("tr", [
                          _c(
                            ...
                            [
                              _c("input", {
                                staticStyle: { height: "10px !important" },
                                attrs: { id: item.IHID, type: "checkbox" },
                                on: {
                                  click: function($event) {
                          ...
                          _c(
                            ...
                            [
                              _c("i", {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.clickDetails(item.IHID)
                                  }
                                }
                              })
                            ]
                              ...
                              [
                                _c(
                                  "b-button",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.searchIncentivesHeader()
                                      }
                                    }
                                  },
                                  [
      ...
      _vm._v(" "),
      _c("search-incentivesHeader", {
        on: {
          rowClick: function($event) {
            return _vm.incentivesHeaderClose($event)
          }
        }
      }),
      _vm._v(" "),
      _c("search-incentivesDetail")
    ],
    1
  )
}
  ...
  function() {
    ...
    return _c("div", { staticClass: "card-header" }, [
      _c("h3", { staticClass: "card-title" }, [
        _c("b", [_vm._v("Create/Generate Incentives Transmittal")])
      ]),
      _vm._v(" "),
...
/***/ "./resources/js/components/Incentives/Transmittal.vue":
/*!************************************************************!*\
  !*** ./resources/js/components/Incentives/Transmittal.vue ***!
  \************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Transmittal_vue_vue_type_template_id_30e37bd3___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Transmittal.vue?vue&type=template&id=30e37bd3& */ "./resources/js/components/Incentives/Transmittal.vue?vue&type=template&id=30e37bd3&");
/* harmony import */ var _Transmittal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Transmittal.vue?vue&type=script&lang=js& */ "./resources/js/components/Incentives/Transmittal.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Transmittal_vue_vue_type_template_id_30e37bd3___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Transmittal_vue_vue_type_template_id_30e37bd3___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Incentives/Transmittal.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/Incentives/Transmittal.vue?vue&type=script&lang=js&":
/*!*************************************************************************************!*\
  !*** ./resources/js/components/Incentives/Transmittal.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/Incentives/Transmittal.vue?vue&type=template&id=30e37bd3&":
/*!*******************************************************************************************!*\
  !*** ./resources/js/components/Incentives/Transmittal.vue?vue&type=template&id=30e37bd3& ***!
  \*******************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Transmittal_vue_vue_type_template_id_30e37bd3___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Transmittal.vue?vue&type=template&id=30e37bd3& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Incentives/Transmittal.vue?vue&type=template&id=30e37bd3&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Transmittal_vue_vue_type_template_id_30e37bd3___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Transmittal_vue_vue_type_template_id_30e37bd3___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
