...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateTitleVehicle: function updateTitleVehicle(updatedTitleVehicle) {
      this.SearchJeepPlateNo = updatedTitleVehicle.PlateNumber;
    ...
    downloadPDF: function downloadPDF() {
      ...
      doc.setProperties({
        title: this.SearchJeepPlateNo + " REPORT as of " + this.DateFrom + " to " + this.DateTo + ".pdf"
      }); //HEADER
      ...
      doc.setFontType("bold");
      doc.text("JEEPNEY'S VEHICLE LOG BILLING", 306, 85, "center");
      doc.setFontType("regular");
      doc.addImage(imageData, "JPEG", 70, 40, 50, 50);
      ...
      doc.text("DATE:", 508, 115, "right");
      doc.setFontType("bold");
      doc.text(datetoday, 571, 115, "right");
      doc.setFontType("regular");
      doc.text("NAME: ", 40, 115, "left");
      doc.setFontType("bold");
      doc.text(this.form.DriverName, 120, 115, "left");
      doc.setFontType("regular");
      doc.text("PERIOD COVERAGE: ", 40, 125, "left");
      doc.setFontType("bold");
      doc.text(datefroms + " - " + datetos, 120, 125, "left");
      doc.autoTable({
        html: "#my-table",
        startY: 130,
        headStyles: {
      ...
      var lessfuel = numeral(this.totalLessFuel).format("0,0.00");
      doc.autoTable({
        head: [["````", "````", "````", "````", "````", "````", "GRAND TOTAL:", "Less Fuel: " + lessfuel, "Amount: " + tots]],
        // body: [
        //     ['', '','','','','','TOTAL:',tots,tots],
        // ...
        // ],
      ...
      doc.text(this.formSOA.PreparedByPos, 90, finalYs + 40, "left");
      var balamt = 0;
      var lf = 0;
      var totstots = 0;
      balamt = parseFloat(this.total).toFixed(2);
      lf = parseFloat(this.totalLessFuel).toFixed(2);
      totstots = balamt - lf;
      console.log("Bal Amount: " + balamt);
      console.log("Less Fuel: " + lf);
      console.log("Total: " + totstots);
      var totals = numeral(totstots).format("0,0.00"); //TOTAL AMOUNT

      doc.setFontType("bold");
      doc.setFontSize(10);
      doc.text("TOTAL: ", 260, finalYs + 20, "left");
      doc.text(totals, 350, finalYs + 20, "left");
      doc.setFontType("regular");
      doc.setFontSize(8);

      var converter = __webpack_require__(/*! number-to-words */ "./node_modules/number-to-words/numberToWords.min.js");

      var words = converter.toWords(totstots).toUpperCase() + " ONLY"; // => “21st”
      //var wordstring =

      doc.setFontType("regular");
      doc.setFontSize(10);
      doc.text("Amount in Words: ", 260, finalYs + 40, "left");
      doc.setFontType("bold"); //doc.text(words+' ONLYasdasDASDASDASDASDASDASDASDAS',260,finalYs+50,'left');

      var splitTitle = doc.splitTextToSize(words, 250);
      doc.text(260, finalYs + 50, splitTitle); //END TOTAL AMOUNT
      //ACROSS Prepared
      ...
      let textWidthssss = doc.getTextWidth(this.formSOA.ReceivedBy);
      doc.setLineWidth(1.5);
      doc.line(310, finalYs+33, 310 + textWidthssss, finalYs+33);
      doc.text(this.formSOA.ReceivedByPos,310,finalYs+40,'left');*/
      //END ACROSS
  ...
  computed: {
      ...
      if (this.DateFrom !== "" || this.DateTo !== "" && this.SearchJeepPlateNo !== "") {
        ...
        return _.filter(vm.jvls, function (data) {
          if (_.isNull(startdate) && _.isNull(enddate)) {
            ...
            var plateno = vm.SearchJeepPlateNo.toLowerCase().split(" ").every(function (v) {
              return data.JeepPlateNo.toLowerCase().includes(v);
            });
            var cons = date >= startdate && date <= enddate && plateno;
            return cons;
    ...
    totalLessFuel: function totalLessFuel() {
      var vm = this;
      /*vm.sum = vm.filteredBlogs.filter((item) =>item.BillAmount)
                      .map((item) => +item.BillAmount)
                      .reduce((sum, current) => sum + current);
      ...
      return vm.filteredBlogs.reduce(function (sum, item) {
        var tot = sum + item.LessFuel;
        vm.sum = tot;
        return sum + item.LessFuel;
      }, 0);
    }
  }
});
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../../node_modules/css-loader??ref--6-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--6-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=template&id=769a19cf&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=template&id=769a19cf& ***!
  \**********************************************************************************************************************************************************************************************************************************/
      ...
      _c("div", { staticClass: "col-xs-12" }, [
        _c("div", { staticClass: "card" }, [
          _c("div", { staticClass: "card-header" }, [
            _c("h3", { staticClass: "card-title" }, [_vm._v("Report List")]),
            _vm._v(" "),
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _c("center", { staticStyle: { display: "none" } }, [
                    _c("h4", [
                      _vm._v("GENERAL SERVICES MULTI-PURPOSE COOPERATIVE")
                    ])
                  ]),
                  _vm._v(" "),
                  _c("center", { staticStyle: { display: "none" } }, [
                  ...
                  _c("center", { staticStyle: { display: "none" } }, [
                    _c("h6", [
                      _vm._v("CDA # 9520-10019987-1 / TIN 411-478-949-000")
                    ])
                  ]),
                  _vm._v(" "),
                  _c("center", { staticStyle: { display: "none" } }, [
                    _c("h5", [_vm._v("JEEPNEY'S VEHICLE LOG BILLING")])
                  ]),
                  _vm._v(" "),
                  _vm._m(9),
                  _vm._v(" "),
                  _c(
                    ...
                    _vm._l(_vm.filteredBlogs, function(jvl) {
                      return _c("tr", { key: jvl.JVLHDRID }, [
                        ...
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(jvl.PerDayRate.toFixed(2)))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(jvl.LessFuel))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(jvl.BalanceAmount.toFixed(2)))])
                      ])
                    }),
                    0
                  )
              ...
              _c(
                "div",
                { staticClass: "col-xs-12", staticStyle: { display: "none" } },
                [
                  _c("div", { staticClass: "row" }, [
                    _c(
                      "div",
                      ...
                      [
                        _c("h4", [
                          _vm._v(
                            "Prepared By: " + _vm._s(_vm.formSOA.PreparedBy)
                          )
                        ])
                      ]
                    )
                  ...
                  _c("div", { staticClass: "row" }, [
                    _c("div", { staticClass: "col" }, [
                      _c("h4", [
                        _vm._v("Checked By: " + _vm._s(_vm.formSOA.CheckedBy))
                      ])
                    ])
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "row" }, [
                    _c("div", { staticClass: "col" }, [
                      _c("h4", [
                        _vm._v("Noted By: " + _vm._s(_vm.formSOA.NotedBy))
                      ])
                    ])
                  ])
                ]
            ...
            _c("div", { staticStyle: { float: "right" } }, [
              _c("div", { staticClass: "input-group mb-3 input-group-sm" }, [
                ...
                _c("input", {
                  ...
                  attrs: { type: "text" },
                  domProps: {
                    value: _vm._f("numeral")(_vm.totalLessFuel, "0,0.00")
                  }
                })
              ]),
              _vm._v(" "),
...
/***/ "./resources/js/components/JeepComponents/ReportJVLPerJeep.vue":
/*!*********************************************************************!*\
  !*** ./resources/js/components/JeepComponents/ReportJVLPerJeep.vue ***!
  \*********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ReportJVLPerJeep_vue_vue_type_template_id_769a19cf___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ReportJVLPerJeep.vue?vue&type=template&id=769a19cf& */ "./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=template&id=769a19cf&");
/* harmony import */ var _ReportJVLPerJeep_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ReportJVLPerJeep.vue?vue&type=script&lang=js& */ "./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _ReportJVLPerJeep_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css& */ "./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _ReportJVLPerJeep_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _ReportJVLPerJeep_vue_vue_type_template_id_769a19cf___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ReportJVLPerJeep_vue_vue_type_template_id_769a19cf___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/JeepComponents/ReportJVLPerJeep.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************!*\
  !*** ./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./ReportJVLPerJeep.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader!../../../../node_modules/css-loader??ref--6-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--6-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=style&index=0&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 

/***/ }),

/***/ "./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=template&id=769a19cf&":
/*!****************************************************************************************************!*\
  !*** ./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=template&id=769a19cf& ***!
  \****************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_template_id_769a19cf___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./ReportJVLPerJeep.vue?vue&type=template&id=769a19cf& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/JeepComponents/ReportJVLPerJeep.vue?vue&type=template&id=769a19cf&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_template_id_769a19cf___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ReportJVLPerJeep_vue_vue_type_template_id_769a19cf___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
